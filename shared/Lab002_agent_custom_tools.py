...
# Onderwerp
# ----------------------------------------------------------------------------
# Azure AI Foundry Agents - Custom Function Tools
#
# Doel
# ----------------------------------------------------------------------------
# Dit bestand bevat de implementatie van drie Python-functies die door een
# Azure AI Foundry Agent als "Function Tools" kunnen worden aangeroepen.
#
# Een Large Language Model (LLM) kan zelf geen bestanden lezen, berekeningen
# uitvoeren of bestanden opslaan op de lokale computer. Hiervoor gebruikt een
# Agent zogenaamde "Tools".
#
# Tijdens een gesprek bepaalt het LLM zelfstandig wanneer een tool nodig is.
# De Agent Runtime roept vervolgens de juiste Python-functie aan en geeft het
# resultaat terug aan het model. Het model verwerkt dit resultaat daarna in
# zijn uiteindelijke antwoord aan de gebruiker.
#
# Architectuur
# ----------------------------------------------------------------------------
#
...
#          │
#          ▼
#   LLM bepaalt dat een Tool nodig is
#          │
#          ▼
#   Python functie in dit bestand
#          │
#          ▼
#   JSON resultaat
#          │
#          ▼
#   Agent verwerkt resultaat
#          │
#          ▼
...
#
#   Zoekt de eerstvolgende astronomische gebeurtenis die zichtbaar is vanaf
#   een opgegeven locatie.
#
#
# calculate_observation_cost(telescope_tier, hours, priority)
#
#   Berekent de kosten van een telescoopreservering op basis van:
#
#       • telescoopcategorie
#       • aantal uren
#       • prioriteitsniveau
...
#
#   Genereert een volledig observatierapport en slaat dit op als een
#   tekstbestand.
#
#
...
#
# data/events.txt
#     Lijst met astronomische gebeurtenissen.
#
# data/telescope_rates.txt
#     Uurtarieven per telescoopcategorie.
#
# data/priority_multipliers.txt
#     Vermenigvuldigingsfactoren voor verschillende prioriteiten.
#
#
# Retourwaarden
# ----------------------------------------------------------------------------
#
# Alle functies retourneren een JSON-string.
#
# Waarom JSON?
#
# Azure AI Foundry Function Tools communiceren via JSON. Hierdoor kan het
# model de geretourneerde gegevens eenvoudig verwerken en gebruiken in het
# verdere gesprek.
#
#
# Opmerking
# ----------------------------------------------------------------------------
#
# Dit bestand bevat uitsluitend de implementatie van de custom tools.
#
# De registratie van deze functies als Azure AI Foundry Function Tools vindt
# plaats in:
#
#     Lab002_Agent.py
#
# Daar worden deze functies gekoppeld aan de Agent zodat het Large Language
# Model ze tijdens een gesprek kan aanroepen wanneer dat nodig is.
#
# ============================================================================
