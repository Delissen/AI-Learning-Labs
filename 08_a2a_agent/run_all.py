...
print("TITLE_AGENT_PORT =", os.getenv("TITLE_AGENT_PORT"))
print("OUTLINE_AGENT_PORT =", os.getenv("OUTLINE_AGENT_PORT"))
print("ROUTING_AGENT_PORT =", os.getenv("ROUTING_AGENT_PORT"))
print("===================")
