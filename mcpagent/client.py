# ============================================================================
# Lab004 - Local MCP Client
# ============================================================================
#
# Description
# -----------
# This client connects an Azure AI Agent with a local MCP server.
#
# The MCP client discovers all tools that are exposed by the server
# and automatically converts them into Azure AI FunctionTools.
#
# During a conversation the agent can decide to invoke one or more
# of these tools to answer the user's question.
#
#
# Sample Prompt: Show me the current inventory levels for all products.
#
# Architecture
# ------------
#
